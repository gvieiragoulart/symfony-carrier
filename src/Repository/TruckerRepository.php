...
class TruckerRepository extends ServiceEntityRepository
{
    ...
    public function save(Trucker $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Trucker[] Returns an array of Trucker objects
//     */
...
//    public function findOneBySomeField($value): ?Trucker
//    {
//        return $this->createQueryBuilder('t')
//            ->andWhere('t.exampleField = :val')
//            ->setParameter('val', $value)
